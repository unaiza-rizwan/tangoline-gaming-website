...
- 🧭 **Sticky Navbar** with active page highlighting across all pages
- 🎬 **Animated Hero Section** with glowing text effects
- 🃏 **Product Grid** with hover effects and smooth transitions
- 🎮 **Brand Filters** — PlayStation / Xbox / Nintendo navigation
- 📬 **Contact Form** with a newsletter subscription section
- 🔐 **Login & Sign-Up Pages** with animated background
